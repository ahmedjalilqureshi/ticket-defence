              ...
              const upload = f.default
                ...
                .push({
                  ...
                  violation: {
                    ...
                    points2: this.props.auth?.ticket?.points2,
                  },
                  status: 1,
                  date: `${moment().format()}`,
                });
                ...
                f.default
                  ...
                  .set({
                    ...
                    violation: {
                      ...
                      image2: this.props.auth?.ticket?.image2,
                      image3: this.props.auth?.ticket?.image3,
                      image4: this.props.auth?.ticket?.image4,
                      image5: this.props.auth?.ticket?.image5,
                      image6: this.props.auth?.ticket?.image6,
                    },
                    status: 1,
                    date: `${moment().format()}`,
                  })
    ...
    return (
      ...
      >
        ...
        <ScrollView style={{height:'100%',width:'100%'}} showsVerticalScrollIndicator={false}>
            <View style={{ width: "100%", paddingBottom: 32, marginBottom: 32 }}>
            ...
            >
              This rate includes your lawyer
            ...
            <Text style={{ fontSize: 14, color: "#030303",marginTop:12 }}>
                By making a hiring from this app, you agree to accept the  
                <Text 
                style={{color:Pink}}
                onPress={() => {Linking.openURL('https://expo.io')}}
                > attorney agreement</Text> and you also agree to accept the <Text
                  style={{ color: Pink }}
                  onPress={() => { Linking.openURL('https://expo.io') }}
                >terms and conditions</Text> of this app.
            </Text>
          </View>
          ...
          <View style={{ width: "100%", marginTop: 40 }}>
            ...
            >
              ...
              >
                  ${this.props.auth?.ticket?.lawyer?.price}
              </Text>
            </View>
