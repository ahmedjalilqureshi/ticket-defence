        ...
        >
          <View style={{ width: "90%" }}>
            <View style={{ width: "100%" }}>
              <Text style={{ color: "black", fontSize: 20, fontWeight: "bold", textAlign: 'center' }}>{item.title}</Text>
            </View>
            <Text style={{ color: "gray", fontSize: 15, marginTop: 10, textAlign: 'center' }}>{item.message}</Text>
          </View>
        </View>
      </ScrollView>
    );
      ...
      >
        <View style={{ width: "100%", flex: 1 }}>
          ...
          >
            ...
            />
            <Text style={{marginHorizontal:14,fontWeight:'bold',color:'#030303'}}>As Seen On!</Text>
